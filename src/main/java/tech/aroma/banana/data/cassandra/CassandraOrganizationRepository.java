...
import static tech.aroma.banana.data.cassandra.Tables.Organizations.DESCRIPTION;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.EMAIL;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.GITHUB_PROFILE;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.ICON_LINK;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.INDUSTRY;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.ORG_ID;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.ORG_NAME;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.OWNERS;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.STOCK_NAME;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.TIER;
import static tech.aroma.banana.data.cassandra.Tables.Organizations.USER_EMAIL;
